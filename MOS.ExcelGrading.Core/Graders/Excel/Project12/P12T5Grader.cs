    ...
    public class P12T5Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                {
                    result.Errors.Add("Không tìm thấy cột 'Inventory Notice'.");
                    return result;
                }
                ...
                {
                    score += 3m;
                    result.Details.Add("Công thức Inventory Notice dung chinh xac.");
                }
                else
                {
                    result.Errors.Add($"Công thức Inventory Notice chưa đúng. Hiện tại: '{noticeColumn.CalculatedColumnFormula}'.");
                }
                ...
                {
                    result.Errors.Add("Text trong cong thuc IF chưa đúng ('Low' / \"\").");
                }
