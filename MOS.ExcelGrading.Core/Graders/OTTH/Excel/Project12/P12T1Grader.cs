    ...
    public class P12T1Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                if (ws == null)
                {
                    result.Errors.Add("Không tìm th?y sheet 'Range'.");
                    return result;
                }
                ...
                {
                    score += 1m;
                    result.Details.Add("Ð?nh d?ng cua o merge duoc giu lai.");
                }
                else
                {
                    result.Errors.Add("Ð?nh d?ng o merge E7:F7 khong hop le.");
                }
