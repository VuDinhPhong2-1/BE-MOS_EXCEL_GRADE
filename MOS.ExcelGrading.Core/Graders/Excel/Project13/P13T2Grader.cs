        ...
        public TaskResult Grade(ExcelWorksheet studentSheet, ExcelWorksheet answerSheet)
        {
            ...
            try
            {
                ...
                if (isMatched)
                {
                    ...
                    result.Details.Add("Công thức C2 dung chinh xac.");
                }
                else
                {
                    result.Errors.Add(
                        $"Công thức C2 chưa đúng. Chap nhan SUMIF(D:D,\"Blue\",F:F) hoac SUMIF(D6:D199,\"Blue\",F6:F199). Hiện tại: '{ws.Cells["C2"].Formula}'.");
                }
            }
            catch (Exception ex)
            {
