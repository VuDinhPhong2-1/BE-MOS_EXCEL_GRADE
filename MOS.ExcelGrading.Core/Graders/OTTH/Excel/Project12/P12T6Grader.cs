    ...
    public class P12T6Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                if (chart == null)
                {
                    result.Errors.Add("Không tìm th?y chart Inventory Level % can kiem tra.");
                    return result;
                }

                score += 1m;
                result.Details.Add("Tìm th?y dung chart Inventory Level %.");
                ...
                {
                    score += 1m;
                    result.Details.Add("Data labels dung vi tri bên ph?i c?t (outEnd).");
                }
                else
                {
                    result.Errors.Add($"Vi tri data label chua dúng. Hi?n t?i: '{dLblPos}'.");
                }
                ...
                {
                    score += 1m;
                    result.Details.Add("Data labels da hien thi giá tr?.");
                }
                else
                {
                    result.Errors.Add("Data labels chua hien thi giá tr?.");
                }
