    ...
    public class P15T5Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                if (ws == null)
                {
                    result.Errors.Add("Không tìm th?y sheet 'Customers'.");
                    return result;
                }
                ...
                {
                    result.Errors.Add("Không tìm th?y c?t 'CurrentAge'.");
                    return result;
                }
                ...
                {
                    result.Errors.Add("Không xác d?nh du?c vung d? li?u c?t CurrentAge.");
                    return result;
                }
                ...
                {
                    result.Errors.Add($"Cot CurrentAge chua dien du. Hi?n t?i: {filledCount}/{totalRows} dòng.");
                }

                if (seriesCorrectCount == totalRows)
                {
                    score += 1m;
                    result.Details.Add("Chuoi d? li?u CurrentAge dung (cong thuc/ket qua hop le tren tat ca dòng).");
                }
                else
                {
                    result.Errors.Add($"Chuoi d? li?u CurrentAge chua dúng ({seriesCorrectCount}/{totalRows} dòng hop le).");
                }
                ...
                {
                    score += 1m;
                    result.Details.Add("Ð?nh d?ng c?t CurrentAge duoc giu on dinh theo mau dòng.");
                }
                else
                {
                    result.Errors.Add("Ð?nh d?ng c?t CurrentAge co dau hieu bi thay doi (khong con on dinh theo mau dòng).");
                }
