    ...
    public class P13T4Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                {
                    score += 2m;
                    result.Details.Add("D201 dung giá tr? mong d?i (191).");
                }
                else
                {
                    result.Errors.Add(
                        $"D201 chua dúng. Expected='191', Hi?n t?i='{studentD201.Text}'.");
                }
                ...
                {
                    score += 2m;
                    result.Details.Add("F201 dung yêu c?u de trong (khong co cong thuc, khong co giá tr?).");
                }
                else
                {
                    result.Errors.Add(
                        $"F201 chua dúng. Expected de trong, hien tai formula='{studentF201.Formula}', text='{studentF201.Text}'.");
                }
