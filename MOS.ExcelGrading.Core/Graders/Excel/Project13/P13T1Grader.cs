    ...
    public class P13T1Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                {
                    score += 2m;
                    result.Details.Add("Không còn giá trị 'Amber' trong cột Shirt Color.");
                }
                else
                {
                    result.Errors.Add($"Van con {amberCount} giá trị 'Amber' trong cột Shirt Color.");
                }
                ...
                {
                    result.Errors.Add("Không tìm thấy giá trị 'Gold' trong cột Shirt Color.");
                }
