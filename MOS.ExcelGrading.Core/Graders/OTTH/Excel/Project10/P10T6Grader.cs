    ...
    public class P10T6Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                if (ws == null)
                {
                    result.Errors.Add("Không tìm th?y sheet 'Enrollment summary'.");
                    return result;
                }
                ...
                if (chart == null)
                {
                    result.Errors.Add("Không tìm th?y chart tren sheet 'Enrollment summary'.");
                    return result;
                }

                score += 1m;
                result.Details.Add("Tìm th?y chart tren sheet 'Enrollment summary'.");
                ...
                {
                    result.Errors.Add($"Chart style XML chua dúng. Choice='{choiceStyle}', Fallback='{fallbackStyle}'.");
                }
                ...
                {
                    result.Errors.Add($"Color style ID chua dúng. Hi?n t?i: '{colorStyleId}' (mong d?i: 19).");
                }
                ...
                {
                    result.Errors.Add($"Chart style ID chua dúng. Hi?n t?i: '{chartStyleId}' (mong d?i: 268).");
                }
