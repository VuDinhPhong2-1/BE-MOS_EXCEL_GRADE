...
namespace MOS.ExcelGrading.Core.Graders.Word.Project11
{
    public sealed class WP11T4Grader : IWordTaskGrader
    {
        ...
        public TaskResult Grade(WordGradingContext studentDocument)
        {
            ...
            if (!WP11GraderHelpers.HasCitationPlaceholderAtEnd(secondParagraph, "Fabrication1"))
            {
                WP11GraderHelpers.AddError(
                    result,
            ...
            {
                WP11GraderHelpers.AddDetail(result, "Đoạn văn thứ hai trong Description có placeholder citation Fabrication1 ở cuối đoạn.");
            }
