    ...
    public class P16T5Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                {
                    score += 2m;
                    result.Details.Add("Công th?c g?c F3 dung: D3*E3.");
                }
                else
                {
                    result.Errors.Add($"Công th?c F3 chua dúng. Hi?n t?i: '{ws.Cells["F3"].Formula}'.");
                }
                ...
                {
                    score += 2m;
                    result.Details.Add("Công th?c da duoc fill down day du F3:F34.");
                }
                else
                {
                    result.Errors.Add($"Công th?c chua fill day du F3:F34 (hien tai {filledRows}/32).");
                }
