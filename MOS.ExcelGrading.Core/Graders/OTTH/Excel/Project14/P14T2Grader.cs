    ...
    public class P14T2Grader : ITaskGrader
    {
        ...
        public TaskResult Grade(ExcelWorksheet studentSheet)
        {
            ...
            try
            {
                ...
                if (ws == null)
                {
                    result.Errors.Add("Không tìm th?y sheet 'March'.");
                    return result;
                }
                ...
                {
                    score += 1m;
                    result.Details.Add("Tìm th?y table March A4:G24.");
                }
                else
                {
                    result.Errors.Add("Không tìm th?y table March A4:G24.");
                    result.Score = score;
                    return result;
                }
                ...
                {
                    score += 3m;
                    result.Details.Add("Filter c?t Policy Type dung giá tr? 'PM'.");
                }
                else
                {
                    result.Errors.Add($"Filter Policy Type chua dúng. Hi?n t?i: '{filterValue}'.");
                }
